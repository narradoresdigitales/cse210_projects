...
class Program
{
    ...
    // Add comments for video1
        ...
        video01.AddComment(new Comment("Mariela", "Well explained!"));
        ...
        video02.AddComment(new Comment("Mario", "Well explained!"));
        video02.AddComment(new Comment("Sylvan", "Thanks for the insights!"));
        video02.AddComment(new Comment("Mariela", "Well explained!"));
        ...
        video03.AddComment(new Comment("Michael", "Well explained!"));
